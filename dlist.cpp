...
ortc_dnode * _ortc_dlist_create_dnode(char* id, char* val1, char* val2, int num, void (*cb)(void*, char*, char*)){
  ortc_dnode *ret;
  if(id == NULL)
    return NULL;
...
void _ortc_dlist_insert(ortc_dlist* dl, char* id, char* val1, char* val2, int num, void (*cb)(void*, char*, char*)){
